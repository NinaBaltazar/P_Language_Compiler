...
const char* tokenTypeToString(TokenType type) {
    switch (type) {
        ...
        case TOKEN_THEN: return "Bloco a ser executado se a condição for verdadeira (então)";
        case TOKEN_ELSE: return "Bloco a ser executado se a condição for falsa (senao)";
        case TOKEN_WHILE: return "Início de estrutura de repetição (enquanto)";
        case TOKEN_REPEAT: return "Início de repetição (repita)";
        case TOKEN_UNTIL: return "Condição de término da repetição (até)";
        ...
        case TOKEN_LT: return "Operador de comparação menor que (<)";
        case TOKEN_LTE: return "Operador de comparação menor ou igual que (<=)";
        case TOKEN_GT: return "Operador de comparação maior que (>)";
        case TOKEN_GTE: return "Operador de comparação maior ou igual que (>=)";
        case TOKEN_EQ: return "Operador de comparação igual a (==)";
        case TOKEN_NEQ: return "Operador de comparação diferente de (!=)";
